...
# URLsExtractor
While hacking or pen-testing you oftenly came across big source code files, JavaScripts files, HTML files or some other heavy files. If you want to extract the URLs/Links from it, this is a short python script to print all the URLs in a nice format and copy it to your clipboard. It's such a tireome task to see for diferent URLS or links in million lines of code. So here is simple python script to make it easy for you

# Requirements
You need python3 and pyperclip package installed. 

# Run
Copy the file content, source code or the large file to your clip board <br />
